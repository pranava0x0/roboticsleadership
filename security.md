...
| 2026-09-26   | <https://pranava0x0.github.io/vibe-coding-security/llms-ctx.txt>      | Swept (index generated 2026-09-25): Mini Shai-Hulud wave, the August agent-framework/MCP CVE batch, and a three-harness OpenRouter retail-attack campaign. None apply: the site has zero runtime dependencies, no package installs this run, workflows are SHA-pinned. |
